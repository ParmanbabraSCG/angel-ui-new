...
import FourIsToThree from "../components/FourIsToThree";
import OneIsToOne from "../components/OneIsToOne";
import SixteenIsToNine from "../components/SixteenIsToNine";
import TwentyOneIsToNine from "../components/TwentyOneIsToNine";
